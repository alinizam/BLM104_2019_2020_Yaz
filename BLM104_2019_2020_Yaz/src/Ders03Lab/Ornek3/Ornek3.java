...
public class Ornek3 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton1.setText("Arka Plana Ekle");
        ...
        jButton2.setText("Arka Plana Yapıcıyla Ekle");
        ...
        jButton4.setText("İsme Göre Sorgula");
        ...
        jButton5.setText("İçinde geçenleri bul");
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        DefaultListModel dlm=new DefaultListModel();
        for (Personel personel : personeller) {
            if (personel.adi.equals(txtAdi.getText())){
                dlm.addElement(personel.adi);
            }
        }
        jList1.setModel(dlm);
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        DefaultListModel dlm=new DefaultListModel();
        for (Personel personel : personeller) {
            if (personel.adi.contains(txtAdi.getText())){
                dlm.addElement(personel.adi);
            }
        }
        jList1.setModel(dlm);
